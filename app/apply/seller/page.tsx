      ...
      <section className="flex-1 bg-cream px-4 py-20 md:py-28">
        <div className="mx-auto max-w-xl">
          ...
          <h1 className="font-display text-[clamp(3rem,8vw,4.5rem)] leading-[0.9] text-espresso uppercase mb-4">
            Reach committed roaster buyers.
          </h1>

          {/* Subtext */}
          <p className="text-lg text-[#7A6A50] leading-relaxed mb-10 max-w-md">
            Exporters, importers, and farm-direct sellers — list your lots to a
            community of specialty roasters who commit before you ship.
          </p>
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tell us about your operation and the coffees you work with."
              ...
              >
                {isSubmitting ? "Sending..." : "Apply as a Seller"}
              </button>
            </form>
          </div>
        </div>
